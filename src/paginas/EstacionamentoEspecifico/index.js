  ...
  return(
    ...
    <Box 
      ...
      <Box mt={5} style={{textAlign:"justify"}}>
        <p><LocationOnIcon color="primary"/> Endereço: Av Afonso de Sampaio e Sousa, 951 São Paulo-SP</p>  
      ...
      <hr/>
      <p>Serviços do local: <CheckBoxIcon style={{color:"green"}}/> Lava-Rapido <CheckBoxIcon style={{color:"green"}}/> Estacionamento coberto </p>
      <Box mb={5}>
        <Button variant="contained" color="primary" onClick={()=>{alert("Uma vaga em seu nome esta reservada Pelo periodo de 2 horas")}}>
            Reservar Vaga
        </Button>
      </Box>
      </Box>
